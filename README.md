Was diving into vibe coding and the whole instance of using AI assistance. Of course you can write out the script fully relying on Cursor, but should contain more than just single scripts.
